 ...
 */
static inline int dtls_sess_get_timeout(const dtls_sess *sess,
                                        struct timeval *tv) {
 ...
 * communication error.
 */
static inline void dtls_sess_renegotiate(dtls_sess *sess, void *carrier,
                                         const void *dest, int destlen) {
...
/*
 * Pointers to specific parts (with fixed lengths) of key material, judged by
 * direction info within srtp_key_material structures.
 */
